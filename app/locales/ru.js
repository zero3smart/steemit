...
const ru = {
	...
	DEBT_TOKEN_will_be_unavailable: '??? ???????? ????? ????????? ????? ?????? ?? ?????????? ??????? ? ?? ?????? ????????. ??? ' + DEBT_TOKEN + ' ????????? ?????? ??????????',
	amount: '??????????',
	convert: '??????????????',
	invalid_amount: '???????? ??????????',
	insufficent_balance: '????????????? ??????',
	in_week_convert_DEBT_TOKEN_to_LIQUID_TOKEN: '?? ?????? ????????? {amount} ' + DEBT_TOKEN + ' ? ' + LIQUID_TOKEN,
	...
	VESTING_TOKEN_is_non_transferrable_and_will_require_2_years_and_104_payments_to_convert_back_to_LIQUID_TOKEN: VESTING_TOKEN + ' ?????? ?????????? ? ??????????? 2 ???? ? 104 ??????? ????? ????????? ??????? ? ' + LIQUID_TOKEN + '.',
	// TODO
  ...
  leave_this_unchecked_to_receive_half_your_reward: '?? ????????? ???????? ????',
	...
	you_successdully_promoted_this_post: '?? ??????? ?????????? ???? ????',
