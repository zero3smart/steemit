...
const ru = {
	...
	DEBT_TOKEN_will_be_unavailable: '??? ???????? ????? ????????? 3,5 ???? ?? ?????????? ??????? ? ?? ?????? ????????. ??? ' + DEBT_TOKEN + ' ????????? ?????? ??????????. ???????? 3,5 ???? ?????????? ????? ????????????? ??????????????? ?? ???? ?? ??????? ??????? ?????????',
	...
	invalid_amount: '???????? ??????????',
	insufficent_balance: '????????????? ??????',
	in_week_convert_DEBT_TOKEN_to_LIQUID_TOKEN: '? 3,5 ??? ????????? {amount} ' + DEBT_TOKEN + ' ? ' + LIQUID_TOKEN_UPPERCASE,
