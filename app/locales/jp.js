const jp = 	{
	...
	learn_more: '?????',
	get_sp_when_sign_up: '?? ??Steem Power?????????????????',
	...
	steem_dollars_will_be_unavailable: '????????????1??????????????Steem Dollars?????????????????. The 3.5 day delay is necessary to prevent abuse from gaming the price feed average',
    ...
    part_of_your_steem_power_is_currently_delegated: '????STEAM POWER??????????????????? ????????????????????steemit?????????????????????? ???????????????????????',
    ...
    terms_violation: '????????steemit.com?????????????????????? support@steemit.com??????????'
}
